...
const ENTRIES: readonly SupportRequestTypeConfig[] = [
  ...
  },
  {
    ...
    icon: 'key-round',
    accent: 'security',
    detailTitle: 'Solicitud de recuperación de contraseña',
    detailSummary: 'El usuario solicita ayuda para restablecer su contraseña. Gestiona el reset desde el Centro de Intervención.',
    messageHeading: 'Detalles aportados',
    primaryActionLabel: 'Marcar como resuelta',
    primaryActionAriaLabel: 'Marcar la solicitud de recuperación de contraseña como resuelta',
