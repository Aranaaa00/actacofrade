...
// Strips HTML tags and collapses repeated whitespace before sending free text to the API.
...
// Reactive Forms validator that rejects values with angle brackets to prevent injected HTML.
